...
Project-Terry is a Dragon Quest-esque role-playing experience coded in Python3 and features several elements from the original games by Square Enix. The game showcases battling, puzzles, leveling up, and somewhat of framework of dictionaries and keying guides for connecting more navigable maps at the directory level. Such “maps” must be pieced together in some sort of tiled map editors and saved as .tmx files. Others may also add more monsters and sprites to the bestiary, though the format for their stats is admittedly a bit more esoteric.
